...
• 可以适当口语、有生活气、带点幽默节奏，但**避免反复使用同一个口头禅**——
  尤其别每段都"您猜怎么着""好家伙""了不得"，这类评书复读腔要克制，换着花样自然表达"""
        char_range = "10~25"
    elif tone == "诗词古文":
        # B82 (2026-06-03): 大哥指出诗词/古文题材不该一刀切禁文言/诗化——念唐诗就得有诗味。此档反其道：保原文、留韵味。
        style_guide = """• 语言风格：尊重古典诗词/古文的文言韵味。引用原诗原文句子时必须 verbatim 照引，绝不改写成大白话（"床前明月光"不可翻成"床前有月光照着"）
• 文学修辞、诗化表达、贴合诗境的意象——这正是诗词题材的灵魂，鼓励使用，不在禁用之列
• 旁白/讲解可用通俗白话帮观众理解背景与意境，但呈现诗句本身时保留其原貌、韵律与对仗
• 生僻字词可保留，顺带用一句白话点出意思，让普通观众也能听懂，但不牺牲原文之美
• 切忌把古诗文降维成口水大白话——观众要的是诗的味道，不是说明书"""
        char_range = "8~30"
    elif tone == "怀旧":
        # B82.1 (2026-06-03): 怀旧本是已判出的档但之前没分支、落进干巴巴的中性。此档要温情有画面感、允许适度抒情。
        style_guide = """• 语言风格：温情怀旧，带画面感和年代质感，唤起共同记忆与共鸣
• 允许适度抒情，用有温度的具体细节和年代意象（粮票、二八大杠、搪瓷缸、黑白电视、收音机里的评书…），但不堆砌不矫情
• 多用具体旧物件、旧场景、旧声音唤起记忆，少用"那个年代""时光荏苒"这类空泛大词
• 语气像跟老朋友念叨旧时光，亲切、慢节奏、有余味
• 不刻意煽情，但结尾可以留一句有回味的感慨"""
        char_range = "10~30"
    else:
...
主题：「{topic}」
基调：{tone}（庄重=克制肃穆 / 轻松=明快活泼 / 怀旧=温暖年代质感 sepia 旧物 / 中性=平实 / 诗词古文=古典写意·诗境·水墨韵味）
