...
Auto-generated. Source: `run_adr_v8.py` (21770 lines). Regenerate: `python3 tools/generate_index.py`.
...
- [`第六步：并行生成图片 + BGM + 视频片段`](#第六步-并行生成图片---bgm---视频片段) — L6944-12578 (5635 lines · 131 fn · 8 sub)
- [`第 6.5 步：动态化（HADS/VADS 默认 ON，--no-motion 关）`](#第-6-5-步-动态化-hads-vads-默认-on---no-motion-关) — L12579-18046 (5468 lines · 117 fn · 6 sub)
- [`第七步：拼接视频轨`](#第七步-拼接视频轨) — L18047-18382 (336 lines · 3 fn · 0 sub)
- [`第八步：生成 ASS 字幕`](#第八步-生成-ass-字幕) — L18383-19341 (959 lines · 10 fn · 1 sub)
- [`第九步：最终合成`](#第九步-最终合成) — L19342-19632 (291 lines · 1 fn · 0 sub)
- [`第十步：推送 Telegram`](#第十步-推送-telegram) — L19633-21515 (1883 lines · 19 fn · 6 sub)
- [`主流程`](#主流程) — L21516-21770 (255 lines · 3 fn · 0 sub)
...
- _MTV：原创歌曲 + 主唱人物库 + WeryDance MV_ — L11216-12178 (963 lines)
- _B68 (2026-05-30) WERYDANCE 段长合规 gate_ — L12179-12411 (233 lines)
- _审批流程_ — L12412-12468 (57 lines)
- _并行等待审批结果，被拒的后台重做再审_ — L12469-12578 (110 lines)
...
- `_mtv_ass_time` — L11670
- `_mtv_ass_escape` — L11679
- `_mtv_wrap_lyric` — L11685
- `_mtv_vocal_span_from_asr` — L11710
- `_mtv_split_lyric_clauses` — L11754
- `_mtv_split_lyric_phrases` — L11766
- `_mtv_norm_zh` — L11779
- `_mtv_best_phrase_offset` — L11783
- `_mtv_asr_phrase_records` — L11803
- `_mtv_alignment_from_script` — L11846
- `_mtv_split_span` — L11899
- `_mtv_song_slice` — L11909
- `_mtv_normalize_segment_duration` — L11917
- `_mtv_static_fallback_segment` — L11953
- `_mtv_lip_sync_segment` — L11975
- `_write_mtv_subtitles` — L12042
- `_mtv_concat_and_render` — L12114
- `run_mtv_pipeline` — L12164
- `_b68_clamp_scene_durations_to_werydance_bounds` — L12187
- `step6_parallel` — L12247

---

### 第 6.5 步：动态化（HADS/VADS 默认 ON，--no-motion 关）
Range: **L12579 – L18046** (5468 lines)

**Sub-sections:**
- _B92 (2026-06-05): 轨迹标记运镜 (Seedance 红线技法)_ — L13723-16182 (2460 lines)
- _PR-A (2026-05-27): merged_a 合并跑 helpers_ — L16183-17781 (1599 lines)
- _pipeline state 持久化：让 tools/rerun_downstream.py 跳过 step1-66 局部重跑下游_ — L17782-17824 (43 lines)
- _audio_dub retiming：按 seg 真实长度重算 timeline，避免克隆语音被截_ — L17825-17862 (38 lines)
- _audio_dub voice-clone splice：把 A-roll seg 里的克隆音色拼回时间轴锚定音轨_ — L17863-18001 (139 lines)
- _silent_b BGM 动态浮起：silent_b 区间 BGM 音量 +40%（让 BGM 接管呼吸位）_ — L18002-18046 (45 lines)

**Top-level constants:**
- `_PR3B1_SHOT_TYPE_ENUM` — L13049
- `_PR3B1_CAMERA_ANGLE_ENUM` — L13053
- `_PR3B1_LIGHTING_ENUM` — L13058
- `_PR3B1_CAMERA_MOTION_ENUM` — L13063
- `_SEEDANCE_CAMERA_GRAMMAR` — L13087
- `_DOLLY_ZOOM_EMOTIONS` — L13100
- `_GRAND_EMOTIONS` — L13105
- `_SEEDANCE_CAMERA_COMPACT` — L13110
- `_B92_HIDE_NEGATIVES` — L13726
- `_EMOTION_NARRATION_STYLE_MAP` — L14373

**Functions:**
- `_generate_motion_prompts` — L12582
- `_motion_tasks_file` — L12649
- `_motion_qa_file` — L12653
- `_append_motion_qa` — L12657
- `_finalize_motion_qa` — L12681
- `_lip_sync_tasks_file` — L12765
- `_load_motion_tasks` — L12769
- `_save_motion_task` — L12779
- `_remove_motion_task` — L12787
- `_load_lip_sync_tasks` — L12794
- `_save_lip_sync_task` — L12804
- `_remove_lip_sync_task` — L12811
- `_video_visual_motion_qa` — L12818
- `_motion_output_qa` — L12890
- `_has_audio_stream` — L12935
- `_normalize_motion_video` — L12946
- `_motion_poll_and_download` — L12996
- `_validate_enum_field` — L13069
- `_seedance_camera_directive` — L13125
- `_build_motion_video_prompt` — L13145
- `_short_board_text` — L13201
- `_wrap_board_text` — L13208
- `_storyboard_font` — L13239
- `_draw_storyboard_arrow` — L13254
- `_build_annotated_storyboard_reference` — L13268
- `_plain_caption_text` — L13369
- `_werydance_caption_request` — L13377
- `_werydance_caption_instruction` — L13404
- `_werydance_negative_prompt` — L13416
- `_motion_reference_prompt` — L13438
- `_motion_audio_dub_prompt` — L13461
- `_motion_audio_dub_poll_and_download` — L13495
- `_try_motion_audio_dub_video` — L13560
- `_b92_enabled` — L13732
- `_b92_propose_path` — L13736
- `_b92_draw_path` — L13777
- `_b92_trim_lead_frames` — L13806
- `_b92_trajectory_prompt` — L13835
- `_b92_apply_trajectory` — L13850
- `_b92_preplan_paths` — L13871
- `_try_motion_reference_video` — L13895
- `_motion_one_scene` — L14026
- `_grid_multiref_tasks_file` — L14156
- `_previs_page_tasks_file` — L14160
- `_load_grid_multiref_tasks` — L14164
- `_load_previs_page_tasks` — L14174
- `_save_grid_multiref_task` — L14184
- `_save_previs_page_task` — L14191
- `_remove_grid_multiref_task` — L14198
- `_remove_previs_page_task` — L14205
- `_poll_video_task_download` — L14212
- `_grid_multiref_group_size` — L14261
- `_grid_multiref_adaptive_group_size` — L14271
- `_grid_multiref_duration` — L14295
- `_grid_multiref_tts_buffer_factor` — L14333
- `_grid_multiref_tts_duration_buffered` — L14347
- `_grid_multiref_segment_max_stretch` — L14363
- `_voice_clone_emotion_style` — L14397
- `_grid_multiref_prompt` — L14420
- `_write_grid_multiref_motion_qa` — L14500
- `_write_previs_page_motion_qa` — L14510
- `_write_storyboard_trailer_qa` — L14520
- `_write_character_trailer_qa` — L14530
- `_write_grid_multiref_segment_qa` — L14540
- `_motion_compare_record` — L14550
- `_write_storyboard_motion_compare_qa` — L14572
- `_scene_segment_duration` — L14608
- `_apply_grid_multiref_segments` — L14627
- `_previs_page_duration` — L14832
- `_previs_page_group_prompt` — L14843
- `_previs_page_groups` — L14869
- `_storyboard_trailer_duration` — L14884
- `_storyboard_trailer_prompt` — L14894
- `_character_trailer_max_shots` — L14922
- `_character_trailer_shot_duration` — L14930
- `_character_trailer_prompt` — L14946
- `_concat_character_trailer_segments` — L14961
- `_generate_character_trailer_motion` — L15000
- `_multi_trailer_prompt_for_group` — L15108
- `_generate_multi_trailer_segments` — L15131
- `_generate_storyboard_trailer_motion` — L15242
- `_generate_previs_page_motion_segments` — L15317
- `_generate_grid_multiref_motion_segments` — L15429
- `_grid_multiref_concat_groups` — L15739
- `_grid_multiref_concat_groups_partial` — L15756
- `_grid_multiref_concat_paths` — L15774
- `_lip_sync_slot_duration` — L15816
- `_adsd_lip_sync_prompt` — L15823
- `_adsd_broll_motion_prompt` — L15869
- `_adsd_action_b_motion_prompt` — L15917
- `_adsd_silent_b_motion_prompt` — L15963
- `_adsd_narrated_b_audio_dub_prompt` — L16004
- `_adsd_almighty_audio_dub_prompt` — L16048
- `_postprocess_lip_sync_segment` — L16089
- `_detect_audio_leading_silence` — L16161
- `_concat_audio_files_for_group` — L16186
- `_split_lip_sync_raw_by_durations` — L16209
- `_postprocess_audio_dub_segment` — L16244
- `_lips_change_repair_segment` — L16372
- `_load_lips_change_requested_turns` — L16457
- `_parse_turn_set` — L16474
- `_load_motion_voice_repair_turns` — L16496
- `_voice_assets_file` — L16508
- `_load_voice_assets` — L16515
- `_build_combined_voice_reference` — L16534
- `_select_voice_asset_reference` — L16576
- `_lip_sync_poll_download_and_process` — L16652
- `_lip_sync_one_group` — L16720
- `_lip_sync_one_scene` — L16928
- `step66_adsd_lip_sync` — L17255
- `step65_motion` — L17600
- `step65_grid_multiref_motion_qa` — L17754
- `_sanitize_scene_for_state` — L17783
- `_save_pipeline_state` — L17802
- `_retime_after_audio_dub` — L17826
- `_build_voice_clone_hybrid_audio` — L17864
- `_build_dynamic_bgm` — L18003

---

### 第七步：拼接视频轨
Range: **L18047 – L18382** (336 lines)

**Functions:**
- `_rescue_motion_image_to_video` — L18048
- `_rescue_motion_text_to_video` — L18083
- `step7_concat` — L18114

---

### 第八步：生成 ASS 字幕
Range: **L18383 – L19341** (959 lines)

**Sub-sections:**
- _字幕分段：LLM 智能语义断句_ — L18662-19341 (680 lines)

**Functions:**
- `_werydance_caption_covered_turns` — L18384
- `_word_timings_for_subtitle_align` — L18410
- `_align_segments_via_asr` — L18451
- `_b61_1_asr_turn_boundaries` — L18494
- `step8_subtitles` — L18556
- `_read_output_json` — L19062
- `_qa_file_pass` — L19073
- `_ass_has_dialogue` — L19080
- `_write_adsd_delivery_qa` — L19090
- `_write_bgm_only_qa` — L19230

---

### 第九步：最终合成
Range: **L19342 – L19632** (291 lines)
...
### 第十步：推送 Telegram
Range: **L19633 – L21515** (1883 lines)

**Sub-sections:**
- _异步封面 + caption（与 step6-9 并发）_ — L20739-20848 (110 lines)
- _B70 (2026-05-30) TG oversize policy helpers_ — L20849-21320 (472 lines)
- _SSL 假阴性防护：见模块级 _tg_probe_send / _tg_probe_delete_ — L21321-21325 (5 lines)
- _尝试 1：requests（timeout 放大到 600s），前后 probe 跳号检测_ — L21326-21390 (65 lines)
- _尝试 2：curl fallback（更稳定，不受 httpx/urllib3 限制），同样跳号检测_ — L21391-21437 (47 lines)
- _尝试 3：小土伯/TG 文件兜底。视频上传链路 SSL 抖动时，压 lite/micro 后用 sendDocument 发文件。_ — L21438-21515 (78 lines)

**Top-level constants:**
- `PANTONE_JIEQI` — L20002
- `PANTONE_FALLBACK` — L20029
- `FESTIVAL_DATE_TAG` — L20143

**Functions:**
- `_generate_caption` — L19634
- `_overlay_title_on_cover` — L19872
- `_prepare_tg_photo` — L19982
- `_get_pantone_for_date` — L20032
- `_llm_bottom_note` — L20057
- `_get_bottom_note` — L20087
- `_get_date_tag` — L20165
- `_shrink_to_b64` — L20187
- `_llm_check_scenes_anomalies` — L20203
- `_llm_check_cover_unique` — L20256
- `_llm_check_cover_quality` — L20286
- `_try_almanac_cover` — L20328
- `_generate_cover_image` — L20499
- `_async_kickoff_cover_caption` — L20746
- `_await_async_cover_caption` — L20822
- `_b70_env_float` — L20852
- `_b70_split_and_deliver` — L20867
- `_b70_send_document_first` — L20980
- `step10_deliver` — L21017

---

### 主流程
Range: **L21516 – L21770** (255 lines)

**Functions:**
- `_print_execution_plan` — L21517
- `_write_run_timings` — L21576
- `main` — L21605
