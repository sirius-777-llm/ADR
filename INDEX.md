...
Auto-generated. Source: `run_adr_v8.py` (22137 lines). Regenerate: `python3 tools/generate_index.py`.
...
- [`第六步：并行生成图片 + BGM + 视频片段`](#第六步-并行生成图片---bgm---视频片段) — L6972-12655 (5684 lines · 131 fn · 8 sub)
- [`第 6.5 步：动态化（HADS/VADS 默认 ON，--no-motion 关）`](#第-6-5-步-动态化-hads-vads-默认-on---no-motion-关) — L12656-18413 (5758 lines · 126 fn · 6 sub)
- [`第七步：拼接视频轨`](#第七步-拼接视频轨) — L18414-18749 (336 lines · 3 fn · 0 sub)
- [`第八步：生成 ASS 字幕`](#第八步-生成-ass-字幕) — L18750-19708 (959 lines · 10 fn · 1 sub)
- [`第九步：最终合成`](#第九步-最终合成) — L19709-19999 (291 lines · 1 fn · 0 sub)
- [`第十步：推送 Telegram`](#第十步-推送-telegram) — L20000-21882 (1883 lines · 19 fn · 6 sub)
- [`主流程`](#主流程) — L21883-22137 (255 lines · 3 fn · 0 sub)
...
- _MTV：原创歌曲 + 主唱人物库 + WeryDance MV_ — L11244-12255 (1012 lines)
- _B68 (2026-05-30) WERYDANCE 段长合规 gate_ — L12256-12488 (233 lines)
- _审批流程_ — L12489-12545 (57 lines)
- _并行等待审批结果，被拒的后台重做再审_ — L12546-12655 (110 lines)
...
- `_mtv_ass_time` — L11710
- `_mtv_ass_escape` — L11719
- `_mtv_wrap_lyric` — L11725
- `_mtv_vocal_span_from_asr` — L11750
- `_mtv_split_lyric_clauses` — L11794
- `_mtv_split_lyric_phrases` — L11806
- `_mtv_norm_zh` — L11819
- `_mtv_best_phrase_offset` — L11823
- `_mtv_asr_phrase_records` — L11843
- `_mtv_alignment_from_script` — L11886
- `_mtv_split_span` — L11939
- `_mtv_song_slice` — L11949
- `_mtv_normalize_segment_duration` — L11957
- `_mtv_static_fallback_segment` — L11993
- `_mtv_lip_sync_segment` — L12015
- `_write_mtv_subtitles` — L12119
- `_mtv_concat_and_render` — L12191
- `run_mtv_pipeline` — L12241
- `_b68_clamp_scene_durations_to_werydance_bounds` — L12264
- `step6_parallel` — L12324

---

### 第 6.5 步：动态化（HADS/VADS 默认 ON，--no-motion 关）
Range: **L12656 – L18413** (5758 lines)

**Sub-sections:**
- _B92 (2026-06-05): 轨迹标记运镜 (Seedance 红线技法)_ — L13915-16442 (2528 lines)
- _PR-A (2026-05-27): merged_a 合并跑 helpers_ — L16443-18148 (1706 lines)
- _pipeline state 持久化：让 tools/rerun_downstream.py 跳过 step1-66 局部重跑下游_ — L18149-18191 (43 lines)
- _audio_dub retiming：按 seg 真实长度重算 timeline，避免克隆语音被截_ — L18192-18229 (38 lines)
- _audio_dub voice-clone splice：把 A-roll seg 里的克隆音色拼回时间轴锚定音轨_ — L18230-18368 (139 lines)
- _silent_b BGM 动态浮起：silent_b 区间 BGM 音量 +40%（让 BGM 接管呼吸位）_ — L18369-18413 (45 lines)

**Top-level constants:**
- `_PR3B1_SHOT_TYPE_ENUM` — L13235
- `_PR3B1_CAMERA_ANGLE_ENUM` — L13239
- `_PR3B1_LIGHTING_ENUM` — L13244
- `_PR3B1_CAMERA_MOTION_ENUM` — L13249
- `_SEEDANCE_CAMERA_GRAMMAR` — L13273
- `_DOLLY_ZOOM_EMOTIONS` — L13286
- `_GRAND_EMOTIONS` — L13291
- `_SEEDANCE_CAMERA_COMPACT` — L13296
- `_B92_HIDE_NEGATIVES` — L13918
- `_EMOTION_NARRATION_STYLE_MAP` — L14609

**Functions:**
- `_generate_motion_prompts` — L12659
- `_motion_tasks_file` — L12726
- `_motion_qa_file` — L12732
- `_append_motion_qa` — L12736
- `_finalize_motion_qa` — L12760
- `_lip_sync_tasks_file` — L12844
- `_normalize_generation_interface` — L12848
- `_generation_task_record` — L12858
- `_normalize_cached_task` — L12876
- `_load_generation_tasks` — L12903
- `_load_motion_tasks` — L12920
- `_save_motion_task` — L12926
- `_remove_motion_task` — L12946
- `_load_lip_sync_tasks` — L12953
- `_mtv_lip_sync_task_key` — L12960
- `_merged_lip_sync_task_key` — L12964
- `_find_merged_lip_sync_task` — L12968
- `_save_lip_sync_task` — L12978
- `_remove_lip_sync_task` — L12997
- `_video_visual_motion_qa` — L13004
- `_motion_output_qa` — L13076
- `_has_audio_stream` — L13121
- `_normalize_motion_video` — L13132
- `_motion_poll_and_download` — L13182
- `_validate_enum_field` — L13255
- `_seedance_camera_directive` — L13311
- `_build_motion_video_prompt` — L13331
- `_short_board_text` — L13387
- `_wrap_board_text` — L13394
- `_storyboard_font` — L13425
- `_draw_storyboard_arrow` — L13440
- `_build_annotated_storyboard_reference` — L13454
- `_plain_caption_text` — L13555
- `_werydance_caption_request` — L13563
- `_werydance_caption_instruction` — L13590
- `_werydance_negative_prompt` — L13602
- `_motion_reference_prompt` — L13624
- `_motion_audio_dub_prompt` — L13647
- `_motion_audio_dub_poll_and_download` — L13681
- `_try_motion_audio_dub_video` — L13747
- `_b92_enabled` — L13924
- `_b92_propose_path` — L13928
- `_b92_draw_path` — L13969
- `_b92_trim_lead_frames` — L13998
- `_b92_trajectory_prompt` — L14027
- `_b92_apply_trajectory` — L14042
- `_b92_preplan_paths` — L14063
- `_try_motion_reference_video` — L14087
- `_resume_motion_task` — L14224
- `_motion_one_scene` — L14256
- `_grid_multiref_tasks_file` — L14378
- `_previs_page_tasks_file` — L14382
- `_load_grid_multiref_tasks` — L14386
- `_load_previs_page_tasks` — L14393
- `_save_grid_multiref_task` — L14400
- `_save_previs_page_task` — L14417
- `_remove_grid_multiref_task` — L14434
- `_remove_previs_page_task` — L14441
- `_poll_video_task_download` — L14448
- `_grid_multiref_group_size` — L14497
- `_grid_multiref_adaptive_group_size` — L14507
- `_grid_multiref_duration` — L14531
- `_grid_multiref_tts_buffer_factor` — L14569
- `_grid_multiref_tts_duration_buffered` — L14583
- `_grid_multiref_segment_max_stretch` — L14599
- `_voice_clone_emotion_style` — L14633
- `_grid_multiref_prompt` — L14656
- `_write_grid_multiref_motion_qa` — L14736
- `_write_previs_page_motion_qa` — L14746
- `_write_storyboard_trailer_qa` — L14756
- `_write_character_trailer_qa` — L14766
- `_write_grid_multiref_segment_qa` — L14776
- `_motion_compare_record` — L14786
- `_write_storyboard_motion_compare_qa` — L14808
- `_scene_segment_duration` — L14844
- `_apply_grid_multiref_segments` — L14863
- `_previs_page_duration` — L15068
- `_previs_page_group_prompt` — L15079
- `_previs_page_groups` — L15105
- `_storyboard_trailer_duration` — L15120
- `_storyboard_trailer_prompt` — L15130
- `_character_trailer_max_shots` — L15158
- `_character_trailer_shot_duration` — L15166
- `_character_trailer_prompt` — L15182
- `_concat_character_trailer_segments` — L15197
- `_generate_character_trailer_motion` — L15236
- `_multi_trailer_prompt_for_group` — L15344
- `_generate_multi_trailer_segments` — L15367
- `_generate_storyboard_trailer_motion` — L15478
- `_generate_previs_page_motion_segments` — L15553
- `_generate_grid_multiref_motion_segments` — L15671
- `_grid_multiref_concat_groups` — L15999
- `_grid_multiref_concat_groups_partial` — L16016
- `_grid_multiref_concat_paths` — L16034
- `_lip_sync_slot_duration` — L16076
- `_adsd_lip_sync_prompt` — L16083
- `_adsd_broll_motion_prompt` — L16129
- `_adsd_action_b_motion_prompt` — L16177
- `_adsd_silent_b_motion_prompt` — L16223
- `_adsd_narrated_b_audio_dub_prompt` — L16264
- `_adsd_almighty_audio_dub_prompt` — L16308
- `_postprocess_lip_sync_segment` — L16349
- `_detect_audio_leading_silence` — L16421
- `_concat_audio_files_for_group` — L16446
- `_split_lip_sync_raw_by_durations` — L16469
- `_postprocess_audio_dub_segment` — L16504
- `_lips_change_repair_segment` — L16632
- `_load_lips_change_requested_turns` — L16717
- `_parse_turn_set` — L16734
- `_load_motion_voice_repair_turns` — L16756
- `_voice_assets_file` — L16768
- `_load_voice_assets` — L16775
- `_build_combined_voice_reference` — L16794
- `_select_voice_asset_reference` — L16836
- `_lip_sync_poll_download_and_process` — L16912
- `_resume_lip_sync_task` — L16988
- `_lip_sync_one_group` — L17017
- `_lip_sync_one_scene` — L17258
- `step66_adsd_lip_sync` — L17611
- `step65_motion` — L17964
- `step65_grid_multiref_motion_qa` — L18121
- `_sanitize_scene_for_state` — L18150
- `_save_pipeline_state` — L18169
- `_retime_after_audio_dub` — L18193
- `_build_voice_clone_hybrid_audio` — L18231
- `_build_dynamic_bgm` — L18370

---

### 第七步：拼接视频轨
Range: **L18414 – L18749** (336 lines)

**Functions:**
- `_rescue_motion_image_to_video` — L18415
- `_rescue_motion_text_to_video` — L18450
- `step7_concat` — L18481

---

### 第八步：生成 ASS 字幕
Range: **L18750 – L19708** (959 lines)

**Sub-sections:**
- _字幕分段：LLM 智能语义断句_ — L19029-19708 (680 lines)

**Functions:**
- `_werydance_caption_covered_turns` — L18751
- `_word_timings_for_subtitle_align` — L18777
- `_align_segments_via_asr` — L18818
- `_b61_1_asr_turn_boundaries` — L18861
- `step8_subtitles` — L18923
- `_read_output_json` — L19429
- `_qa_file_pass` — L19440
- `_ass_has_dialogue` — L19447
- `_write_adsd_delivery_qa` — L19457
- `_write_bgm_only_qa` — L19597

---

### 第九步：最终合成
Range: **L19709 – L19999** (291 lines)
...
### 第十步：推送 Telegram
Range: **L20000 – L21882** (1883 lines)

**Sub-sections:**
- _异步封面 + caption（与 step6-9 并发）_ — L21106-21215 (110 lines)
- _B70 (2026-05-30) TG oversize policy helpers_ — L21216-21687 (472 lines)
- _SSL 假阴性防护：见模块级 _tg_probe_send / _tg_probe_delete_ — L21688-21692 (5 lines)
- _尝试 1：requests（timeout 放大到 600s），前后 probe 跳号检测_ — L21693-21757 (65 lines)
- _尝试 2：curl fallback（更稳定，不受 httpx/urllib3 限制），同样跳号检测_ — L21758-21804 (47 lines)
- _尝试 3：小土伯/TG 文件兜底。视频上传链路 SSL 抖动时，压 lite/micro 后用 sendDocument 发文件。_ — L21805-21882 (78 lines)

**Top-level constants:**
- `PANTONE_JIEQI` — L20369
- `PANTONE_FALLBACK` — L20396
- `FESTIVAL_DATE_TAG` — L20510

**Functions:**
- `_generate_caption` — L20001
- `_overlay_title_on_cover` — L20239
- `_prepare_tg_photo` — L20349
- `_get_pantone_for_date` — L20399
- `_llm_bottom_note` — L20424
- `_get_bottom_note` — L20454
- `_get_date_tag` — L20532
- `_shrink_to_b64` — L20554
- `_llm_check_scenes_anomalies` — L20570
- `_llm_check_cover_unique` — L20623
- `_llm_check_cover_quality` — L20653
- `_try_almanac_cover` — L20695
- `_generate_cover_image` — L20866
- `_async_kickoff_cover_caption` — L21113
- `_await_async_cover_caption` — L21189
- `_b70_env_float` — L21219
- `_b70_split_and_deliver` — L21234
- `_b70_send_document_first` — L21347
- `step10_deliver` — L21384

---

### 主流程
Range: **L21883 – L22137** (255 lines)

**Functions:**
- `_print_execution_plan` — L21884
- `_write_run_timings` — L21943
- `main` — L21972
